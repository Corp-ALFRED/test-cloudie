<?php
/*
Custom Field Builder for CloudIESystem

CloudIESystem 同梱の Custom Field Builder は
	...
	class VK_Custom_Field_Builder {
		...
		*/
		public static function print_script() {
			...
			wp_enqueue_script( 'client-display-name', self::admin_directory_url() . 'js/client-display-name.js', array( 'jquery', 'jquery-ui-sortable' ), self::$version, true );
		}
