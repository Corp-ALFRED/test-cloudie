	...
	public static function custom_fields_array()
	{
		...
		$custom_fields_array = array(
			...
			'client_address' => array(
				'label' => __('住所','cloud-ie-system'),
				'type' => 'textarea',
				'description' => '',
				'required' => false,
			),
			'client_section' => array(
				'label' => __('担当者部署名','cloud-ie-system'),
				'type' => 'textarea',
				'description' => '',
				'required' => false,
			),
			'client_doc_destination' => array(
				'label' => __('[ 送付状 ] 宛名','cloud-ie-system'),
				'type' => 'text',
				'description' => '宛名が未入力の場合は「取引先名 + 敬称」が表記されます。',
				'required' => false,
			),
			'client_doc_content' => array(
				'label' => __('[ 送付状 ] 同封書類内容','cloud-ie-system'),
				'type' => 'textarea',
				'description' => '例）請求書・・・・・・・・・・・・・・・・・・・・・・・・１通',
				'required' => false,
			),
			'client_doc_tantou' => array(
				'label' => __('[ 送付状 ] 担当者名（送信者名）','cloud-ie-system'),
				'type' => 'text',
				'description' => '',
				'required' => false,
			),
			'client_doc_send_date' => array(
				'label' => __('[ 送付状 ] 表記する書類送付日','cloud-ie-system'),
				'type' => 'datepicker',
			...
			'client_hidden' => array(
				'label' => __('ドロップダウンへの表示','cloud-ie-system'),
				'type' => 'checkbox',
