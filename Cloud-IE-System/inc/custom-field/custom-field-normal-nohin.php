...
class Nohin_Normal_Custom_Fields {
	...
	public static function fields_form() {
		...
		$custom_fields_array = Nohin_Normal_Custom_Fields::custom_fields_array();
		$befor_custom_fields = '';
	...
	public static function custom_fields_array() {
		...
		$custom_fields_array = array(
			...
			/*
			'bill_id' => array(
				'label' => __('受け渡し期間','cloud-ie-system'),
				'type' => 'text',
				'description' => '',
				'required' => false,
			),
			'bill_Issue_date' => array(
				'label' => __('発行日','cloud-ie-system'),
				'type' => 'datepicker',
				'description' => '',
				'required' => true,
			),
			'bill_tax_rate'            => array(
				'label'       => __( '消費税率', 'cloud-ie-system' ),
				'type'        => 'radio',
				'description' => '',
				'required'    => false,
				'options'     => array(
			...
			*/
			'bill_tax_fraction' => array(
				'label'       => __( '消費税の端数処理', 'cloud-ie-system' ),
				'type'        => 'radio',
				'description' => '',
				'required'    => false,
				'options'     => array(
					'round' => __( '四捨五入', 'cloud-ie-system' ),
					'ceil'  => __( '切り上げ', 'cloud-ie-system' ),
					'floor' => __( '切り捨て', 'cloud-ie-system' ),
				),
			),
			'bill_total_price_display' => array(
				'label'       => __( '合計の表示', 'cloud-ie-system' ),
				'type'        => 'checkbox',
			...
			'bill_send_pdf'            => array(
				'label'       => __( '送付済PDF', 'cloud-ie-system' ),
				'type'        => 'file',
...
Nohin_Normal_Custom_Fields::init();