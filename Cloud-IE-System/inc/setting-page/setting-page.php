			...
			<form id="bill-setting-form" method="post" action="">
				...
				<table class="form-table">
					<tr>
						<th>請求者名</th>
						<td>
							<textarea name="bill-setting[own-name]" rows="2"><?php echo esc_textarea($options['own-name']); ?></textarea>
						</td>
					</tr>
					<tr>
						<th>インボイス制度の登録番号</th>
						<td>
							T<input type="text" name="bill-setting[invoice-number]" value="<?php echo esc_attr($options['invoice-number']); ?>" />
						</td>
					</tr>
					<tr>
						<th>住所</th>
					...
					<tr>
						...
						<td>
							...
							<button id="media_own-logo" class="media_btn btn btn-default button button-default"><?php _e('画像を選択', ''); ?></button>
						</td>
					</tr>
					<tr>
						<th>印鑑画像</th>
						<td>
							...
							<button id="media_own-seal" class="media_btn btn btn-default button button-default"><?php _e('画像を選択', ''); ?></button>
						</td>
					</tr>
					<tr>
						<th>振込先</th>
					...
					<tr>
						<th>見積書テーブルカラー</th>
						<?php $m_table_bg_color = (isset($options['m-table-bg-color'])) ? $options['m-table-bg-color'] : ''; ?>
						<td><input type="color" name="bill-setting[m-table-bg-color]" class="m-bg-color-field" value="<?php echo esc_attr($m_table_bg_color); ?>"></td>
					</tr>
					<tr>
						<th>請求書テーブルカラー</th>
						<?php $s_table_bg_color = (isset($options['s-table-bg-color'])) ? $options['s-table-bg-color'] : ''; ?>
						<td><input type="color" name="bill-setting[s-table-bg-color]" class="s-bg-color-field" value="<?php echo esc_attr($s_table_bg_color); ?>"></td>
					</tr>
					<tr>
						<th>納品書テーブルカラー</th>
						<?php $n_table_bg_color = (isset($options['n-table-bg-color'])) ? $options['n-table-bg-color'] : ''; ?>
						<td><input type="color" name="bill-setting[n-table-bg-color]" class="n-bg-color-field" value="<?php echo esc_attr($n_table_bg_color); ?>"></td>
					</tr>
